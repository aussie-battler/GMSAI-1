...
if (toLower(GMS_modType) isEqualTo "epoch") then
{
	...
	[_player,_killstreakBonus + _reward] call GMS_fnc_giveTakeCrypto;
	["showScore",[_reward + _killstreakBonus,_killstreakBonus,_kills],[_player]] call GMS_fnc_messageplayers;
} else {
